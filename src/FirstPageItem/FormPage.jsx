        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <VStack gap={4}>
            ...
            <input
              ...
              {...register("ICPassport", { required: true })}
              style={{
                backgroundColor: "white",
                color: "black",
                width: "300px", // Adjust width as needed
            ...
            {errors.Nationality && (
              <span style={{ color: "red" }}>Nationality is required</span>
            )}
            ...
            {errors.ServiceOption && (
              <span style={{ color: "red" }}>Service Option is required</span>
            )}
            ...
            <Button type="submit" _hover={{ bg: "green" }} colorPalette="peal" onClick={onSubmit}>
              Submit
            </Button>
          </VStack>
        </form>
